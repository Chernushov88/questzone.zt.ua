...
class PLL_Share_Post_Slug {
	...
	public function parse_query( $query ) {
		if ( $lang = $this->get_language_for_filter( $query ) ) {
			...
			if ( ! empty( $qv['pagename'] ) ) {
				/*
				 * A simpler solution is avalaible at http://github.com/mirsch/polylang-slug/commit/4bf2cb80256fc31347455f6539fac0c20f403c04
	 ...
	 * Thanks to @AndyDeGroo for http://wordpress.org/support/topic/plugin-polylang-identical-page-names-in-different-languages?replies=8#post-2669927
	 * Thanks to Ulrich Pogson for http://github.com/grappler/polylang-slug/blob/master/polylang-slug.php
	 *
	 * @since 1.9
	 *
