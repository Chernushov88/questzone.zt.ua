...
if ( ! function_exists( 'wpml_get_language_information' ) ) {
	 ...
	 *
	 * @see original WPML code at http://wpml.org/forums/topic/canonical-urls-for-wpml-duplicated-posts/#post-52198
	 *
	 * @since 1.8
	 *
...
if ( ! function_exists( 'wpml_get_default_language' ) ) {
	 ...
	 *
	 * @see http://wordpress.org/support/topic/add-wpml-compatibility-function
	 *
	 * @since 1.8.2
	 *
	 * @return string default language code
