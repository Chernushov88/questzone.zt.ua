...
class PLL_Translated_Post extends PLL_Translated_Object {
	...
	public function get_untranslated( $type, $untranslated_in, $lang, $search = '' ) {
		...
		// Don't order by title: see http://wordpress.org/support/topic/find-translated-post-when-10-is-not-enough
		$args = array(
			's'                => $search,
		 ...
		 *
		 * @see http://wordpress.org/support/topic/find-translated-post-when-10-is-not-enough
		 *
		 * @since 1.7
		 *
