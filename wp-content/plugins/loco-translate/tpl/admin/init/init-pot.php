...
?> 
    ...
    <div class="notice inline notice-generic">
        ...
        <p>
            ...
            <a class="icon icon-help" href="<?php echo esc_url(apply_filters('loco_external','http://localise.biz/wordpress/plugin/faqs/skipped-files'))?>" target="_blank"><span class="screen-reader-text">Help</span></a>
            </em>
        </p><?php
        endif?> 
        <p>
