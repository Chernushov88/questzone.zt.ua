...
<p>
    <a href="<?php echo esc_url(apply_filters('loco_external','http://localise.biz/wordpress/plugin/manual/settings'))?>" target="_blank"><?php esc_html_e('Full documentation','loco-translate')?></a>
</p>
