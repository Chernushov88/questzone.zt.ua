...
$this->extend('../layout');
    ...
    <div class="notice inline notice-warning">
        ...
        <p class="submit">
            ...
            <a class="button button-link has-icon icon-ext" href="http://wordpress.org/plugins/loco-translate/installation/" target="_blank"><?php esc_html_e( __('Install manually','loco-translate') )?></a>
        </p>
    </div><?php
