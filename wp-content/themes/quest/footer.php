    ...
    <div class="qroom-content_inner _nclear">
      ...
      <div class="qroom-footer_list _contacts">
        ...
        <div class="qroom-footer_list_item">
          Житомир <div class="material-icons">place</div>
          ул. Победы 3
        </div>
        <div class="qroom-footer_list_item">
          <div class="material-icons">phone</div>
          Тел.: <span>
    <a style="font-size: 22px; font-family: Roboto, sans-serif; color: #BDDF01;" href="tel:+380971514542">097-15-14-542</a>
        </span>
        </div>
	<span>Мы в соцсетях<span>
      ...
      <div class="qroom-footer_list _contacts">
        ...
        <div class="qroom-footer_list_item" style="line-height: 1.25;margin-bottom: 0; float:left; "> 
          ...
          <a href="https://www.facebook.com/QuestZoneZt/" target="_blank"><span><div class="material-icons" style="color: #aaabb5;"><i class="fa fa-facebook fa-3x" aria-hidden="true"></i></div></span></a>
        </div>
        <div class="qroom-footer_list_item" style="float:left;margin-left:10px;">
          
          <a href="https://www.instagram.com/quest_zone_zhytomyr/" target="_blank"><span><div class="material-icons" style="color: #aaabb5;"><i class="fa fa-instagram fa-3x" aria-hidden="true"></i></div></span></a>
        </div>
      </div>
        ...
        <div class="qroom-booking_qopup">
          ...
          <form id="myform"  action="" class="qroom-form qroom-booking_form" method="post">
                ...
                <div class="qroom-row">
                  <div class="qroom-col-6">
                    <div class="qroom-form_field">
                      <input type="text" class="qroom-input qroom-need_validate" placeholder="Имя *" data-validations="empty,not_null" data-error="Введите ваше имя" name="Name" maxlength="100" minlength="3"  required>
                      <div class="qroom-form_field_error"></div>
                    </div>
                  </div>
                  <div class="qroom-col-6">
                    <div class="qroom-form_field">
                      <input type="text" class="qroom-input qroom-need_validate phone" placeholder="Ваш телефон *" data-validations="empty,phone" data-error="Введите ваш телефон" name="Phone" required>
                      <div class="qroom-form_field_error"></div>
                    </div>
                  </div>
                </div>
                <div class="qroom-form_field">
                  <input type="email" class="qroom-input qroom-need_validate" placeholder="Email" data-validations="" data-error="E-mail*" name="Email">
                  <div class="qroom-form_field_error"></div>
                </div>
              </div>
              <div class="qroom-col-6">
                <div class="qroom-form_field">
                  <textarea class="qroom-textarea" data-title="Комментарий" placeholder="Комментарий" name="Comment"></textarea>
                  <div class="qroom-form_field_error"></div>
                </div>
              </div>
            </div>
                  ...
                  <tr>
                    ...
                    <td class="qroom-form_price">
                      ...
                      <div class="qroom-form_price_now">
                        <i class="material-icons">account_balance_wallet</i>Цена: <span class="qroom-booking_qopup_cost_holder currency rub">2&nbsp;000</span>
                      </div>
                    </td>
                  </tr>
                </tbody>
            ...
            <div class="qroom-booking_terms">
              ...
              <div class="qroom-checkbox _checked" onclick="qroom.checkbox(this);">
                <input type="checkbox" class="qroom-need_validate" data-validations="checked" data-error="Подтвердите" name="Privacy">
                <i class="material-icons qroom-checkbox_icn _outline">check_box_outline_blank</i>
                <i class="material-icons qroom-checkbox_icn _check_icn">check_box</i>
                Я ознакомлен с<a href="/files/politika_konfidentsialnosti.pdf" target="_blank"> политикой конфиденциальности</a>
                <div class="qroom-form_field_error"></div>
              </div>
            </div>
          </form>
...
<style>
  .country-selector.weglot-default{opacity: 0;}
</style>
