...
<div class="qroom-booking" id="booking">
  ...
  <div class="qroom-booking_body">
    <div class="qroom-content_inner">
      ...
      <div class="qroom-booking_holder" id="qroom_booking_holder" data-title="Нажмите на плитку с удобным временем, чтобы Забронювати игру!">
        1111111111111
        <?php echo do_shortcode('[jt-calendar-level-1]'); ?>
      </div>
      <div class="qroom-booking_holder" data-title="Нажмите на плитку с удобным временем, чтобы Забронювати игру!" onmouseover="qroom.ttip.show({ el: this })" onmouseout="qroom.ttip.hide(this);">
