      ...
      <div class="qroom-quests_item_hover">
        ...
        <div class="qroom-quests_item_hover_inner">
          ...
          <div class="qroom-quests_item_btns">
            <div>
              <a onclick="qroom.analytics.track('quest', 'game_click', { label: 'from_gamelist_hover_button_big' });" class="qroom-btn _big qr-booking-button" href="/kvest-komnata-1#booking">Забронировать</a>
            </div>
    ...
    <div class="qroom-quests_item" id="qroom-quests-list-item-1062" data-filter="">
      ...
      <div class="qroom-quests_item_hover">
        ...
        <div class="qroom-quests_item_hover_inner">
          ...
          <div class="qroom-quests_item_btns">
            <div>
              <a onclick="qroom.analytics.track('quest', 'game_click', { label: 'from_gamelist_hover_button_big' });" class="qroom-btn _big qr-booking-button" href="/kvest-komnata-2#booking">Забронировать</a>
            </div>
