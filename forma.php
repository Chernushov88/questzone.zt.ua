...
$sub="Сообщение с сайта: http://questzone.zt.ua/gift/";
$messageTB = "
‼ $sub ‼
...
$headers .= 'From: http://questzone.zt.ua/gift/';
...
//$verify = mail($address, $sub ,$mes, "Content-type:text/plain; charset = utf-8\r\nFrom:$mail_info");
	        ...
	        echo "<html><head><meta http-equiv='refresh' content='2; URL=http://questzone.zt.ua/gift/'/></head><body><div class='otpravleno'>Совсем скоро с Вами свяжется наш менеджер</div></body></html>";
	    } else {
